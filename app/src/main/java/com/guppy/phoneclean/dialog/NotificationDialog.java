...
public class NotificationDialog extends Dialog {
    ...
    protected NotificationDialog(@NonNull @NotNull Context context) {
        this(context, R.style.InstallUinstallWindowDialog);
    }

    protected NotificationDialog(@NonNull @NotNull Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        private View view;
        private NotificationDialog.IDialogListenter listenterPositive, listenterNegative;
        private final NotificationDialog iAlertDialog;

        public TextView dialogTipImg,dialogTipTxt;
        public TextView deleteBtn,cancelBtn;

        public Builder(Context context) {
            iAlertDialog = new NotificationDialog(context);
            view = LayoutInflater.from(context).inflate(R.layout.dialog_notification, null);
            //添加布局文件到 Dialog
        ...
        public NotificationDialog.Builder setCance(boolean flag) {
            this.flag = flag;
            return this;
        }

        public NotificationDialog.Builder setText(@Nullable String text) {
            dialogTipTxt.setText(text);
            dialogTipTxt.setVisibility(View.VISIBLE);
            return this;
        }

        public NotificationDialog.Builder setTitle(@Nullable String text) {
        ...
        public NotificationDialog.Builder setConfirmButton(@Nullable String text, final NotificationDialog.IDialogListenter listener) {
        ...
        public NotificationDialog.Builder setCancelButton(final NotificationDialog.IDialogListenter listener) {
            this.listenterNegative = listener;
            if (listener != null) cancelBtn.setVisibility(View.VISIBLE);
            return this;
        }

        public NotificationDialog.Builder setCancelButton(String text, final NotificationDialog.IDialogListenter listener) {
            this.listenterNegative = listener;
            if (listener != null) {
