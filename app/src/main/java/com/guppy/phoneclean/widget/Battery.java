...
public class Battery extends View {
    ...
    public Battery(Context context, @Nullable AttributeSet attrs) {
        ...
        lowPowerColor = typedArray.getColor(R.styleable.Battery_lowPowerColorB, Color.parseColor("#000000"));
        middlePowerColor = typedArray.getColor(R.styleable.Battery_middlePowerColorB, Color.parseColor("#000000"));
        enoughPowerColor = typedArray.getColor(R.styleable.Battery_enoughPowerColorB, Color.parseColor("#000000"));
        strokeWidth = typedArray.getDimensionPixelSize(R.styleable.Battery_strokeWidthB, 20);
        strokeColor = typedArray.getColor(R.styleable.Battery_strokeColorB, Color.parseColor("#000000"));
        textSize = typedArray.getDimensionPixelSize(R.styleable.Battery_textSizeB, 50);
        textColor = typedArray.getColor(R.styleable.Battery_textColorB, Color.parseColor("#000000"));
