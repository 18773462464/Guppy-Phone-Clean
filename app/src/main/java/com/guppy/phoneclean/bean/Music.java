...
import com.guppy.phoneclean.utils.PinyinUtils;
...
public class Music implements Comparable<Music> {
    ...
    public Music(String name, String path, String album, String artist, long size, int duration, boolean acctivated) {
        this.name = name;
        this.path = path;
        this.album = album;
        this.artist = artist;
